...
var NseIndia = /** @class */ (function () {
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        setCookies.forEach(function (cookie) {
                            var requiredCookies = ['nsit', 'nseappid'];
    ...
    NseIndia.prototype.getData = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            var retries, hasError, response, _a, _b, _c, _d, error_1;
            var _e, _f;
            return __generator(this, function (_g) {
                switch (_g.label) {
                    ...
                    case 5: return [4 /*yield*/, _b.apply(_a, _c.concat([(_e.headers = (_f[_d] = _g.sent(),
                                _f),
                                _e)]))];
                    case 6:
                        response = _g.sent();
    ...
    NseIndia.prototype.getEquityIntradayData = function (symbol, isPreOpenData) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getEquityDetails(symbol)];
                    case 1:
                        details = _a.sent();
    ...
    NseIndia.prototype.getEquityHistoricalData = function (symbol, range) {
        return __awaiter(this, void 0, void 0, function () {
            var data, dateRanges, promises;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!!range) return [3 /*break*/, 2];
                        return [4 /*yield*/, this.getEquityDetails(symbol)];
                    case 1:
                        data = _a.sent();
                    ...
                    case 2:
                        ...
                        promises = dateRanges.map(function (dateRange) { return __awaiter(_this, void 0, void 0, function () {
                            ...
                            return __generator(this, function (_a) {
                                switch (_a.label) {
                                    case 0:
                                        url = "/api/historical/cm/equity?symbol=" + encodeURIComponent(symbol) +
                                            ("&series=[%22EQ%22]&from=" + dateRange.start + "&to=" + dateRange.end);
                                        return [4 /*yield*/, this.getDataByEndpoint(url)];
                                    case 1:
                                        data = _a.sent();
    ...
    NseIndia.prototype.getIndexIntradayData = function (index, isPreOpenData) {
        if (isPreOpenData === void 0) { isPreOpenData = false; }
        var url = "/api/chart-databyindex?index=" + index + "&indices=true";
        if (isPreOpenData)
            url += '&preopen=true';
